...
export function NewBranchDialog({ open, onConfirm, onCancel }: Props) {
  ...
  return (
    <div style={overlay}>
      <form onSubmit={handleSubmit} style={modal}>
        <h3 style={{ margin: '0 0 0.75rem', fontSize: 'var(--font-size-base)' }}>New Branch</h3>
        <input
          autoFocus
          value={name}
          onChange={e => setName(e.target.value)}
          placeholder="Branch name (e.g. engineering)"
          style={input}
        />
